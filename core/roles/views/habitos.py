...
from core.base.models import Habit, HabitCompletion
...
def habito_list(request):
    ...
    return render(request, 'core/habito_list.html', {'habits': habits})
...
def habito_create(request):
    ...
    return render(request, 'core/habito_form.html')
